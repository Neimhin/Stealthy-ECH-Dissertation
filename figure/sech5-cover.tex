...
\colorlet{color4}{purple}
    ...
    \pgfmathsetmacro{\tagbegin}{\encend+1}
    \pgfmathsetmacro{\tagend}{\tagbegin+\taglen-1}
    \pgfmathsetmacro{\ciphertextbegin}{\tagend+1}
    \pgfmathsetmacro{\ciphertextend}{\ciphertextbegin+\servernamelen+\randomlen-1}
    \pgfmathsetmacro{\servernamebegin}{\tagend+1}
...
\draw[decorate,decoration={brace,amplitude=10pt,raise=4pt},yshift=\shiftfar cm]
(\tagbegin*\boxwidth,0) -- (\tagend*\boxwidth,0) node[midway,yshift=\textshift cm]{$t$};

\draw[decorate,decoration={brace,amplitude=10pt,raise=4pt},yshift=\shiftfar cm]
(\ciphertextbegin*\boxwidth,0) -- (\ciphertextend*\boxwidth,0) node[midway,yshift=\textshift cm]{cipher text $ct$};
