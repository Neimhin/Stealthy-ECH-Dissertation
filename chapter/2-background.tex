...
\subsection{TLS 1.3}
      ...
      - **p:** various unfortunate cludges such as the version field indicating 1.2 and true version in \var{supported_versions} extension, but these are not a big problem
